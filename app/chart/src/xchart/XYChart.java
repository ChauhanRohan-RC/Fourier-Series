...
import xchart.internal.chartpart.Plot_XY;
...
public class XYChart extends Chart<XYStyler, XYSeries> {
  ...
  public XYSeries addSeries(String seriesName, double[] xData, double[] yData) {
    ...
    return addSeries(seriesName, xData, yData, null, Series.DataType.Number);
  }
  ...
  public XYSeries addSeries(String seriesName, double[] xData, double[] yData, double[] errorBars) {
    ...
    return addSeries(seriesName, xData, yData, errorBars, Series.DataType.Number);
  }
  ...
  private XYSeries addSeries(
      String seriesName, double[] xData, double[] yData, double[] errorBars, Series.DataType dataType) {
