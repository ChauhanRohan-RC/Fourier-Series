...
import xchart.internal.Utils;
import xchart.internal.chartpart.AxisPair;
import xchart.internal.chartpart.Chart;
import xchart.internal.chartpart.Legend_OHLC;
import xchart.internal.chartpart.Plot_OHLC;
import xchart.internal.style.SeriesColorMarkerLineStyle;
import xchart.internal.style.SeriesColorMarkerLineStyleCycler;
import xchart.style.OHLCStyler;
...
public class OHLCChart extends Chart<OHLCStyler, OHLCSeries> {
  ...
  public OHLCSeries addSeries(
    ...
    Series.DataType dataType = getDataType(xData);
    switch (dataType) {
      case Date:
        return addSeries(
            seriesName,
  ...
  public OHLCSeries addSeries(String seriesName, double[] xData, double[] yData) {
    ...
    return addSeries(seriesName, xData, yData, Series.DataType.Number);
  }
  ...
  private Series.DataType getDataType(List<?> data) {
    ...
    if (data == null || data.isEmpty()) {
      return Series.DataType.Number; // It will be autogenerated
    }
  ...
  public OHLCSeries addSeries(
    ...
    return addSeries(
        seriesName, xData, openData, highData, lowData, closeData, null, Series.DataType.Number);
  }
  ...
  public OHLCSeries addSeries(
    ...
    return addSeries(
        seriesName, xData, openData, highData, lowData, closeData, volumeData, Series.DataType.Number);
  }
  ...
  private OHLCSeries addSeries(
      String seriesName, double[] xData, double[] yData, Series.DataType dataType) {
  ...
  public OHLCSeries updateOHLCSeries(
    ...
    Series.DataType dataType = getDataType(newXData);
    switch (dataType) {
      case Date:
