...
import xchart.internal.chartpart.Legend_HeatMap;
import xchart.internal.chartpart.Plot_HeatMap;
...
public class HeatMapChart extends Chart<HeatMapStyler, HeatMapSeries> {
  ...
  /**
   * Add a graphSeries for a HeatMap type chart using using int arrays
   *
   * @param seriesName
  ...
  /**
   * Add a graphSeries for a HeatMap type chart using using List<?>
   *
   * @param seriesName
   * @param xData the X-Axis data
  ...
  /**
   * Update a graphSeries by updating the X-Axis, Y-Axis and heat data
   *
   * @param seriesName
   * @param xData
   * @param yData
