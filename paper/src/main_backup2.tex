...
\hypersetup{
	colorlinks=true,
	linkcolor=[RGB]{255,110,0},
	citecolor=[RGB]{255,110,0}
}
...
\end{equation}
where $\gamma = 1/\sqrt{1 - \beta^{2}}$ is the \textbf{\textit{Lorentz Factor}}. % Since Kinetic energy is same as the energy gained by the body when brought from rest to velocity $v=\beta c$
...
% \end{equation}
%which for small $\beta$ reduces to $E_{kinetic} = m_{0}v^{2}/2$ (classical form).\\ 
