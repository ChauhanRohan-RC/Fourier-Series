...
\begin{document}
	...
	%%%%%%%%%%%%%%%%%%%%%%%PLEASE FOCUS ON THE AIM OF THIS PAPER IN THE CONTEXT OF THE UNCERTAINTY PRINCIPLE!!!%%%%%%%%%%
	...
	\begin{figure}[H]
		...
		\caption{A 2D linear spring with free length $5$ cm and free turn frequency $f_{t} = 4$ turns/cm. Dashed line represents spring axis.}
		\label{fig:spring.5cm_4Hz.linear}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\subfloat[$f_{w} = 0.17$ circular wraps/cm. incomplete wrapping around the circle] {
			\begin{tikzpicture}
				\label{fig:spring.5cm_4Hz.wound.wrap_fq1}
				\begin{axis} [
					axis lines=middle, 
					xmin=-2.5, 
					xmax=2.5, 
					...
					{ (cos((360 * 4 * t) + 180) + 1) * cos(360 * 0.17 * t) },
					{ (cos((360 * 4 * t) + 180) + 1) * sin(360 * 0.17 * t) }
					);
					
					\draw[dotted, color=black, fill=none] (0, 0) circle (1.0);
					
					\draw[color=red, fill=red] (-0.12, 0.054) circle (1.5pt) node[above] {};
					
				\end{axis}
			\end{tikzpicture}
		}\hfill
		\subfloat[$f_{w} = 0.20$ circular wraps/cm. One rotation around the circle] {
			\begin{tikzpicture}
				\label{fig:spring.5cm_4Hz.wound.wrap_fq2}
				\begin{axis} [
					axis lines=middle, 
					xmin=-2.5, 
					xmax=2.5, 
					...
					{ (cos((360 * 4 * t) + 180) + 1) * cos(360 * 0.20 * t) },
					{ (cos((360 * 4 * t) + 180) + 1) * sin(360 * 0.20 * t) }
					);
		...
		\subfloat[$f_{w} = 0.64$ circular wrap/cm] {
			\begin{tikzpicture}
				\label{fig:spring.5cm_4Hz.wound.wrap_fq3}
				\begin{axis} [
					axis lines=middle, 
					xmin=-2.5, 
					xmax=2.5, 
					...
					{ (cos((360 * 4 * t) + 180) + 1) * cos(360 * 0.64 * t) },
					{ (cos((360 * 4 * t) + 180) + 1) * sin(360 * 0.64 * t) }
					);
					
					\draw[dotted, color=black, fill=none] (0, 0) circle (1.0);
					
					\draw[color=red, fill=red] (0.048544386, 0.035269524
					) circle (1.5pt) node[above] {};
					
				\end{axis}
			\end{tikzpicture}
		}\hfill
		\subfloat[$f_{w} = 1.32$ circular wraps/cm] {
			\begin{tikzpicture}
				\label{fig:spring.5cm_4Hz.wound.wrap_fq4}
				\begin{axis} [
					axis lines=middle, 
					xmin=-2.5, 
					xmax=2.5, 
					...
					{ (cos((360 * 4 * t) + 180) + 1) * cos(360 * 1.32 * t) },
					{ (cos((360 * 4 * t) + 180) + 1) * sin(360 * 1.32 * t) }
					);
					
					\draw[dotted, color=black, fill=none] (0, 0) circle (1.0);
					
					\draw[color=red, fill=red] (-0.015906362, 0.04895479
					) circle (1.5pt) node[above] {};
		...
		\subfloat[$f_{w} = 2.52$ circular wraps/cm] {
			\begin{tikzpicture}
				\label{fig:spring.5cm_4Hz.wound.wrap_fq5}
				\begin{axis} [
					axis lines=middle, 
					xmin=-2.5, 
					xmax=2.5, 
					...
					{ (cos((360 * 4 * t) + 180) + 1) * cos(360 * 2.52 * t) },
					{ (cos((360 * 4 * t) + 180) + 1) * sin(360 * 2.52 * t) }
					);
					
					\draw[dotted, color=black, fill=none] (0, 0) circle (1.0);
					
					\draw[color=red, fill=red] (-0.012310478, 0.037888201) circle (1.5pt) node[above] {};
					
				\end{axis}
			\end{tikzpicture}
		}\hfill
		\subfloat[$f_{w} = f_{t} = 4$ circular wrap/cm. COM is unusally far from origin] {
			\begin{tikzpicture}
				\label{fig:spring.5cm_4Hz.wound.wrap_fq_eq_turn_fq}
				\begin{axis} [
					axis lines=middle, 
					xmin=-2.5, 
					xmax=2.5, 
					...
					{ (cos((360 * 4 * t) + 180) + 1) * cos(360 * 4 * t) },
					{ (cos((360 * 4 * t) + 180) + 1) * sin(360 * 4 * t) }
					);
	...
	\begin{figure}[H]
		...
		\subfloat[x-coordinate of COM vs $f_{w}$] {
			\begin{tikzpicture}
				\label{fig:spring.5cm_4Hz.wound_com.real_vs_wrap_fq}
				\begin{axis} [
					axis lines=left, 
					xmin=1, 
					xmax=8.4, 
					...
					\addplot[thin, smooth, color=red] table [header=true, col sep=comma, x=frequency, y=real] {res/data/2d_spring_5cm_4Hz_phase_180_wound_up_com.csv};
		...
		\subfloat[Distance of COM from origin vs $f_{w}$] {
			\begin{tikzpicture}
				\label{fig:spring.5cm_4Hz.wound_com.mag_vs_wrap_fq}
				\begin{axis} [
					axis lines=left, 
					xmin=1, 
					xmax=8.4, 
					...
					\addplot[thin, smooth, color=red] table [header=true, col sep=comma, x=frequency, y=mag] {res/data/2d_spring_5cm_4Hz_phase_180_wound_up_com.csv};
	...
	This wrapping of a 2D spring around a circle for the extraction of frequency information also works for deformed springs. This is illustrated in figure \ref{fig:spring.deformed.5cm.2_and_3_Hz.plots}. Consequently, a deformed 2D spring correlates with multiple frequencies, as shown in figure \ref{fig:spring.deformed.5cm.2_and_3_Hz.wound.com_vs_wrap_fq}, where it correlates highly with $2$ and $3$ wraps/cm. It is analogous to a signal made up of combination of multiple pure frequencies.
	
	\begin{figure}[H]
		\centering
		\subfloat[A 2D linear deformed spring]{
			\begin{tikzpicture}
				\label{fig:spring.deformed.5cm.2_and_3_Hz}
				\begin{axis} [
					axis lines=left, 
					xmin=0, 
					xmax=5, 
					...
					mark=false
						...
						cos((360 * 2 * t) + 0) + cos((360 * 3 * t) + 0) + 2
					};
					
				\end{axis}
			\end{tikzpicture}
		}\hfill
		\subfloat[Variation of distance of the COM from origin as wrapping frequency changes] {
			\begin{tikzpicture}
				\label{fig:spring.deformed.5cm.2_and_3_Hz.wound.com_vs_wrap_fq}
				\begin{axis} [
					axis lines=middle, 
					xmin=0, 
					xmax=5.6, 
					...
					\addplot[thin, smooth, color=red] table [header=true, col sep=comma, x=frequency, y=mag] {res/data/2d_deformed_spring_5cm_2_and_3Hz_phase_180_wound_up_com.csv};
					
				\end{axis}
			\end{tikzpicture}
		}
		
		\caption{Frequency analysis of a 2D linear deformed spring by wrapping it around a circle with frequency $f_{w}$ and tracking the resulting center of mass.}
		\label{fig:spring.deformed.5cm.2_and_3_Hz.plots}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\subfloat[Pure signal $f(t)$ with frequency $2$ Hz]{
			\begin{tikzpicture}
				\label{fig:mathematical_construct_of_wrapping_signal___signal_2hz}
				\begin{axis} [
					axis lines=left, 
					xmin=0, 
					xmax=4, 
		...
		\subfloat[Point rotating in complex plane around the circumference of unit circle anticlockwise expressed as $e^{2\pi if_{w}t}$]{
			\begin{tikzpicture}
				\label{fig:mathematical_construct_of_wrapping_signal___rotating_point_in_complex_plane}
				\begin{axis} [
					axis lines=middle, 
					xmin=-1.8, 
					xmax=1.8, 
		...
		\subfloat[Wrapped up signal as the product of $f(t)$ and $e^{2\pi if_{w}t}$. Here $f_{w}=0.25$ cycles/s]{
			\begin{tikzpicture}
				\label{fig:mathematical_construct_of_wrapping_signal___wrapped_signal_wrap_fq_0.25}
				\begin{axis} [
					axis lines=middle, 
					xmin=-2.9, 
					xmax=2.9, 
					...
					{ (cos((360 * 2 * t) + 0) + 1) * cos((360 * 0.25 * t) + 0) },
					{ (cos((360 * 2 * t) + 0) + 1) * sin((360 * 0.25 * t) + 0) }
					);
					...
					\draw[color=red, fill=red] (0,0) circle (1.9pt) node[above] {};
					
				\end{axis}
			\end{tikzpicture}
		}\hfill
		\subfloat[Wrapped up signal with frequency $f_{w}=2$ rotations/s]{
			\begin{tikzpicture}
				\label{fig:mathematical_construct_of_wrapping_signal___wrapped_signal_wrap_fq_eq_signal_fq}
				\begin{axis} [
					axis lines=middle, 
					xmin=-2.9, 
					xmax=2.9, 
					...
					{ (cos((360 * 2 * t) + 0) + 1) * cos((360 * 2 * t) + 0) },
					{ (cos((360 * 2 * t) + 0) + 1) * sin((360 * 2 * t) + 0) }
					);
					...
					\draw[color=red, fill=red] (0.5,0) circle (1.9pt) node[above] {};
					
				\end{axis}
			\end{tikzpicture}
		}
		
		\caption{Mathematics of wrapping a signal around a circle of unit radius in the complex plane with wrapping frequency $f_{w}$. The wrapped up signal can be traced by scaling a point which is rotating in complex plane (given by $e^{2\pi if_{w}t}$) by the signal $f(t)$ i.e $f(t)e^{2\pi if_{w}t}$ represents the wrapped signal. The location of center of mass of wrapped up signal (shown as red dot) is approximated by sampling some points from the graph (shown as green dots), and then taking their average.}
		\label{fig:mathematical_construct_of_wrapping_pure_signal_in_complex_plane}
	\end{figure}
	...
	%%%%%%%%%%%%%%% FUNCTION MAY NOT ALWAYS BE COMPLEX, EXPLAIN PHASE OFFSET!!!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	However, for the signal that persist for long time (requires long metal wire), as the wrapping frequency shifts even slightly from $2$ Hz, the wrapped up signal easily balances itself around the origin due to long length of the wire. Center of mass is therefor pulled back to the origin quite effectively as wrapping frequency shifts away from $2$ Hz, giving a relatively sharp peak at $2$ Hz.
	
	\begin{figure}[H]
		\centering
		\subfloat[Pure signal $f(t)$ with frequency $2$ Hz persisting for $4$ secs]{
			\begin{tikzpicture}
				\label{fig:pure_signal_2hz_short_time}
				\begin{axis} [
					axis lines=left, 
					xmin=0, 
					xmax=4, 
		...
		\subfloat[Fourier Transform spectrum of $f(t)$] {
			\begin{tikzpicture}
				\label{fig:spectrum_of_pure_signal_2hz_short_time}
				\begin{axis} [
					axis lines=middle, 
					xmin=0, 
					xmax=4.2, 
					...
					\addplot[thin, smooth, color=red] table [header=true, col sep=comma, x=frequency, y=mag] {res/data/signal_4s_2Hz_FT_spectrum.csv};
					
				\end{axis}
			\end{tikzpicture}
		}
		
		\caption{Fourier Transform of a pure signal persisting for short time duration}
		\label{fig:pure_signal_and_its_spectrum_short_time}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\subfloat[Pure signal $f(t)$ with frequency $2$ Hz persisting for $20$ secs]{
			\begin{tikzpicture}
				\label{fig:pure_signal_2hz_long_time}
				\begin{axis} [
					axis lines=left, 
					xmin=0, 
					xmax=20, 
		...
		\subfloat[Fourier Transform spectrum of $f(t)$] {
			\begin{tikzpicture}
				\label{fig:spectrum_of_pure_signal_2hz_long_time}
				\begin{axis} [
					axis lines=middle, 
					xmin=0, 
					xmax=4.2, 
					...
					\addplot[thin, smooth, color=red] table [header=true, col sep=comma, x=frequency, y=mag] {res/data/signal_20s_2Hz_FT_spectrum.csv};
	...
	%%%%%%%%%%%%%%%%BOTH f(t) and spectrum are ARE PROBABILITY DISTRIBUTIONS???%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%%%%%%%%%%%%%%%%%%ANY MEASURE OF THIS SPREAD???VARIANCE??%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%%%%%%%%%%%%%%%%%%%CAN IT BE CENTERED AT $t=t^\prime??$%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{enumerate}
		...
		%%%%%%%%%%%%%%$\frac{0}{0} IS INDETERMINATE!!!CANNOT BE DEFINED!!!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\section{Conclusion}
	%%%%%%%%%%%%%%%%%%%%%%%PLEASE SUMMARIZE! GIVE THE KEY POINTS!!!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
