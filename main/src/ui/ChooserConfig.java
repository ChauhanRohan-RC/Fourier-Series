...
public class ChooserConfig {
    ...
    @Nullable
    private Collection<? extends FileFilter> fileFilters;
    @Nullable
    ...
    public static class Builder {
        ...
        public Builder setFileFilters(@Nullable Collection<FileFilter> fileFilters) {
            config.fileFilters =  fileFilters;
            return this;
        }

        public Builder setFileFilters(FileFilter @Nullable ... fileFilters) {
            return setFileFilters(fileFilters != null? List.of(fileFilters): null);
        }
    ...
    private ChooserConfig(@NotNull ChooserConfig src) {
        ...
        fileFilters = src.fileFilters != null? new ArrayList<>(src.fileFilters): null;
    ...
    @Nullable
    public Collection<? extends FileFilter> getFileFilters() {
        return fileFilters;
    }
    ...
    public static JFileChooser createFileChooser(@NotNull ChooserConfig config) {
        ...
        final Collection<? extends FileFilter> fileFilters = config.getFileFilters();
        if (fileFilters != null) {
