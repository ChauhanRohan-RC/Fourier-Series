...
import main.models.function.x.GraphicFunction;
...
public class PathFunctionMerger extends GraphicFunction implements ColorHandler {
    ...
    public PathFunctionMerger(@NotNull PathFunction[] segments, @NotNull Rectangle2D bounds, float zoom, boolean center) throws IllegalArgumentException {
        ...
        double _msDef = 0, _msMin = 0, _msMax = 0;
    ...
    @Override
    public final double getDomainRangeTravelMsDefault() {
        return msDef;
    }

    @Override
    public final double getDomainRangeTravelMsMin() {
        return msMin;
    }

    @Override
    public final double getDomainRangeTravelMsMax() {
        return msMax;
    }
