 ...
 * in the main.R Matching package [3], can be used if ties are known to be present in the data.
 * </p>
 * <p>
 ...
 * The Matching package for main.R</a> Journal of Statistical Software, 42(7): 1-52.</li>
...
public class KolmogorovSmirnovTest {
     ...
     * When {@code strict} is true, this is equivalent to the algorithm implemented in the main.R function
     * {@code ks.boot}, described in <pre>
     * Jasjeet S. Sekhon. 2011. 'Multivariate and Propensity Score Matching
     * Software with Automated Balance Optimization: The Matching package for main.R.'
     ...
     * This is equivalent to ks.boot(x,y, nboots=iterations) using the main.R Matching
