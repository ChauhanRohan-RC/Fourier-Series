 ...
 * main.R<sup>T</sup> (Q<sup>T</sup>Q) main.R b = main.R<sup>T</sup> Q<sup>T</sup> y
 * main.R<sup>T</sup> main.R b = main.R<sup>T</sup> Q<sup>T</sup> y
 * (main.R<sup>T</sup>)<sup>-1</sup> main.R<sup>T</sup> main.R b = (main.R<sup>T</sup>)<sup>-1</sup> main.R<sup>T</sup> Q<sup>T</sup> y
 * main.R b = Q<sup>T</sup> y </code></pre></p>
 *
 * <p>Given <code>Q</code> and <code>main.R</code>, the last equation is solved by back-substitution.</p>
 *
 * @since 2.0
 */
public class OLSMultipleLinearRegression extends AbstractMultipleLinearRegression {
     ...
     * the {@link #calculateRSquared() main.R-squared} computation.</p>
     *
    ...
    /**
     * Returns the main.R-Squared statistic, defined by the formula <pre>
     * main.R<sup>2</sup> = 1 - SSR / SSTO
     * </pre>
     ...
     *
     * @return main.R-square statistic
     * @throws NullPointerException if the sample has not been set
     * @throws org.apache.commons.math3.linear.SingularMatrixException if the design matrix is singular
     * @since 2.2
     */
    ...
    /**
     * <p>Returns the adjusted main.R-squared statistic, defined by the formula <pre>
     * main.R<sup>2</sup><sub>adj</sub> = 1 - [SSR (n - 1)] / [SSTO (n - p)]
     * </pre>
     * where SSR is the {@link #calculateResidualSumOfSquares() sum of squared residuals},
     ...
     * <p>If there is no variance in y, i.e., SSTO = 0, NaN is returned.</p>
     *
     * @return adjusted main.R-Squared statistic
     * @throws NullPointerException if the sample has not been set
     * @throws org.apache.commons.math3.linear.SingularMatrixException if the design matrix is singular
     * @see #isNoIntercept()
     * @since 2.2
     ...
     * to (main.R<sup>T</sup>main.R)<sup>-1</sup>, with only the top p rows of
     * main.R included, where p = the length of the beta vector.</p>
     *
     * <p>Data for the model must have been successfully loaded using one of
     * the {@code newSampleData} methods before invoking this method; otherwise
     * a {@code NullPointerException} will be thrown.</p>
