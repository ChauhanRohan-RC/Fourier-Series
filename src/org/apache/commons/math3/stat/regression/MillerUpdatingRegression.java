...
public class MillerUpdatingRegression implements UpdatingMultipleLinearRegression {
    ...
    /** the elements of the main.R`Y */
    private final double[] rhs;
    /** the off diagonal portion of the main.R matrix */
    ...
    private void singcheck() {
        ...
        for (int col = 0; col < nvars; col++) {
            // Set elements within main.R to zero if they are less than tol(col) in
     ...
     * If IN = 1, and the first row of main.R represents a constant in the
