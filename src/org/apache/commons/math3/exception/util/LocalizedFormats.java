...
public enum LocalizedFormats implements Localizable {
    ...
    HOLE_BETWEEN_MODELS_TIME_RANGES("{0} wide hole between main.models time ranges"),
    ...
    UNABLE_TO_PERFORM_QR_DECOMPOSITION_ON_JACOBIAN("unable to perform Q.main.R decomposition on the {0}x{1} jacobian matrix"),
