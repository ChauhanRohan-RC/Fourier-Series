 ...
 * <p>The QR-decomposition of a matrix A consists of two matrices Q and main.R
 * that satisfy: A = QR, Q is orthogonal (Q<sup>T</sup>Q = I), and main.R is
 * upper triangular. If A is m&times;n, Q is m&times;m and main.R m&times;n.</p>
...
public class QRDecomposition {
     ...
     * matrix main.R, and the rows ABOVE the diagonal are the Householder reflector vectors
     * from which an explicit form of Q can be recomputed if desired.</p>
     */
    private double[][] qrt;
    /** The diagonal elements of main.R. */
    private double[] rDiag;
    /** Cached value of Q. */
    private RealMatrix cachedQ;
    /** Cached value of QT. */
    private RealMatrix cachedQT;
    /** Cached value of main.R. */
    ...
    /**
     * Returns the matrix main.R of the decomposition.
     * <p>main.R is an upper-triangular matrix</p>
     * @return the main.R matrix
     */
    public RealMatrix getR() {

        if (cachedR == null) {

            // main.R is supposed to be m x n
    ...
    private static class Solver implements DecompositionSolver {
         ...
         * @param rDiag Diagonal elements of main.R.
         * @param threshold Singularity threshold.
         */
        ...
        public RealVector solve(RealVector b) {
            ...
            // solve triangular system main.R.x = y
