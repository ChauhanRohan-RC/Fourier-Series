...
public interface RealDistribution {
     ...
     * returned value is
     * <ul>
     * <li><code>inf{x in main.R | P(X<=x) >= p}</code> for {@code 0 < p <= 1},</li>
     * <li><code>inf{x in main.R | P(X<=x) > 0}</code> for {@code p = 0}.</li>
     * </ul>
     *
     ...
     * method must return
     * <p><code>inf {x in main.R | P(X <= x) > 0}</code>.</p>
     *
     ...
     * method must return
     * <p><code>inf {x in main.R | P(X <= x) = 1}</code>.</p>
     *
