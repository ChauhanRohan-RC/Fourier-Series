...
public class Complex implements FieldElement<Complex>, Serializable  {
    ...
    @Nullable
    private transient Boolean mIsNaN;
    /** Record whether this complex number is infinite. */
    @Nullable
    private transient Boolean mIsInfinite;
    ...
    public boolean isNaN() {
        if (mIsNaN == null) {
            mIsNaN = Double.isNaN(real) || Double.isNaN(imaginary);
        }
    ...
    public boolean isInfinite() {
        if (mIsInfinite == null) {
            mIsInfinite = !isNaN() && (Double.isInfinite(real) || Double.isInfinite(imaginary));
        }
     ...
     *  </code>
     * </pre>
     * where ln on the right hand side is {@link FastMath#exp(double)},
