 ...
 * noise covariance matrices. The parameter names used in the respective main.models
 ...
 * <li>main.R - measurement noise covariance matrix</li>
...
public class KalmanFilter {
    ...
    /**
     * Creates a new Kalman filter with the given process and measurement main.models.
     *
     * @param process
    ...
    public KalmanFilter(final ProcessModel process, final MeasurementModel measurement)
        ...
        // row dimension of main.R must be equal to row dimension of H
